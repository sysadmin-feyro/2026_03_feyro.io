...
const Navigation = () => {
  ...
  return (
    <>
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 px-3 pt-3 sm:px-6">
        <div className="mx-auto max-w-7xl rounded-[1.75rem] border border-slate-200/80 bg-white/90 px-3 shadow-[0_8px_32px_rgba(16,30,80,0.10)] backdrop-blur-md sm:rounded-full sm:px-6">
          ...
          <div className="flex shrink-0 items-center">
            <a href="#hero" aria-label="feyro.io – zur Startseite" className="font-display text-xl font-bold tracking-tight text-slate-900 sm:text-2xl">
              feyro
            </a>
          </div>
      ...
      {/* Mobile Navigation */}
      {isOpen && (
        <div className="mx-3 mt-2 rounded-[1.75rem] border border-slate-200/80 bg-white/95 p-3 shadow-[0_8px_32px_rgba(16,30,80,0.10)] backdrop-blur-md md:hidden sm:mx-6 sm:rounded-[2rem]">
